...
class EvoMan:
    def __init__(self, experiment_name, enemy, population_size, generations, mutation_rate, crossover_rate, 
                 mode, n_hidden_neurons, headless, dom_l, dom_u, speed, number_of_crossovers, n_elitism, k_tournament, sel_pres_incr, 
                 k_tournament_final_linear_increase_factor, sigma_range):
    ...
    def evaluate(self, population):
        ...
        for i, individual in enumerate(population):
            fitness[i], health_gain[i], time_game[i] = self.simulation(individual['weights'])
...
def run_evoman(experiment_name, enemy, population_size, generations, mutation_rate, crossover_rate, mode, 
               n_hidden_neurons, headless, dom_l, dom_u, speed, number_of_crossovers, n_elitism, k_tournament, sel_pres_incr, k_tournament_final_linear_increase_factor, sigma_range):
        evoman = EvoMan(experiment_name, enemy, population_size, generations, mutation_rate, crossover_rate, 
                        mode, n_hidden_neurons, headless, dom_l, dom_u, speed, number_of_crossovers, n_elitism, k_tournament, sel_pres_incr, k_tournament_final_linear_increase_factor, sigma_range)
...
if __name__ == "__main__":
        ...
        run_evoman(args.experiment_name, args.enemies, args.npop, args.gens, args.mutation_rate, args.crossover_rate,
               ...
               args.n_elitism, args.k_tournament, args.selection_pressure_increase, args.k_tournament_final_linear_increase_factor, args.sigma_range)