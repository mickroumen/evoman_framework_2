    ...
    def train(self):
        ...
        with open(results_file_path, mode='w', newline='') as file:
            ...
            for gen in range(self.gens):
                ...
                print(f"Generation {gen}, Best Health: {np.max(health_gain)}")                
...
if __name__ == "__main__":
        ...
        parser.add_argument("--k_tournament_final_linear_increase_factor", type=int, default= 6, help="The factor with which k_tournament should linearly increase (if selection_pressure_increase = True), if the value is 4 the last quarter of generations have tournaments of size k_tournament*4")
