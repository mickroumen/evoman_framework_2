...
class EvoMan:
    ...
    def initialize_individual(self):
        ...
        individual = np.append(individual, self.sigma)
    ...
    def train(self):
        ...
        with open(results_file_path, mode='w', newline='') as file:
            ...
            for gen in range(self.gens):
                ...
                children = []
                for _ in range(self.n_pop*4):  # Two children per iteration so double the population size out of which we will select the best
...
def run_evoman(experiment_name, enemies, population_size, generations, mutation_rate, crossover_rate, mode, 
               n_hidden_neurons, headless, dom_l, dom_u, speed, number_of_crossovers, n_elitism, k_tournament, type_of_selection_pressure, k_tournament_final_linear_increase_factor, alpha, enemy_threshold, sigma):
        evoman = EvoMan(experiment_name, enemies, population_size, generations, mutation_rate, crossover_rate, 
                        mode, n_hidden_neurons, headless, dom_l, dom_u, speed, number_of_crossovers, n_elitism, k_tournament, type_of_selection_pressure, k_tournament_final_linear_increase_factor, alpha, enemy_threshold, sigma)
...
if __name__ == "__main__":
        ...
        parser.add_argument("--sigma", type=int, default=0.5, help="the initial mutation step size for each individual")
        ...
        run_evoman(args.experiment_name, args.enemies, args.npop, args.gens, args.mutation_rate, args.crossover_rate,
               ...
               args.alpha, args.enemy_threshold, args.sigma)