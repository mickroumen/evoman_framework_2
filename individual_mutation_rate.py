        ...
        if random.uniform(0,1) < self.crossover_rate: 
            ...
            for i in range(number_of_crossovers - 1):
                ...
                if i%2 == 0:
                    ...
                    child2[crossover_points[i]:crossover_points[i+1]] = parent2[crossover_points[i]:crossover_points[i+1]]
...
if __name__ == "__main__":
        ...
        parser.add_argument("--k_tournament_final_linear_increase_factor", type=int, default= 5, help="The factor with which k_tournament should linearly increase (if type_of_selection_pressure = True), if the value is 4 the last quarter of generations have tournaments of size k_tournament*4")
